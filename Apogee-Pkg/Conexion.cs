...
namespace SupplyPro_Project
{
    class Conexion
    {
        ...
        Con1 = new SqlConnection(@"Data Source=192.168.1.4\SQLEXPRESS;Initial Catalog=apogeedb;User ID=admin;Password=mbettaglo;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        //RESPARLDO
        //Con1 = new SqlConnection(@"Data Source=MEX-W10-9SANKBV\SQLEXPRESS;Initial Catalog=apogeedb;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
        ...
        public int ReturnID(string comando)
        {
            string valor;
            try
            {
